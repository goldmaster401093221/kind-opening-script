...
const Quotation = () => {
  ...
  const { messages, loading: chatLoading, addMessage } = useAIChat('quotation');
      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: `You are a helpful assistant specializing in quotation services. You help users with:
              - Price quotes for products and services
              - Cost estimates and budgeting
              - Quotation preparation and formatting
              - Vendor comparison and evaluation
              - Contract negotiation guidance
              - Market pricing analysis
              - RFQ (Request for Quote) assistance
              
              Always be professional, helpful, and provide accurate pricing and quotation information.`
            },
            {
              role: 'user',
              content: userMessage
  ...
  const navigationItems = [
    ...
    { 
      ...
      subItems: [
        ...
        { icon: FileText, label: 'Quotation', path: '/quotation', isActive: true },
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 border-b border-border bg-card flex items-center justify-between px-6">
          <h1 className="text-xl font-semibold text-foreground">Quotation</h1>
          <Button 
        ...
        <div className="border-t border-border bg-card p-4">
          <div className="flex space-x-2">
            <Input
              ...
              placeholder="Ask about quotation services..."
              disabled={isLoading}
              className="flex-1"
            />
            <Button 
